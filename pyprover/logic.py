...
class BoolOp(BinaryOp):  #701 (line in Coconut source)
    ...
    def clean(self):  #741 (line in Coconut source)
        ...
        return _coconut_tail_call((self.__class__), *(filter)(_coconut_partial((_coconut.operator.ne), self.identity), self.elems))  #743 (line in Coconut source)
