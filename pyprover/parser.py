...
def exists_handle(*_coconut_match_args, **_coconut_match_kwargs):  #77 (line in Coconut source)
...
def exists_handle(*_coconut_match_args, **_coconut_match_kwargs):  #80 (line in Coconut source)
...
def forall_handle(*_coconut_match_args, **_coconut_match_kwargs):  #83 (line in Coconut source)
...
def forall_handle(*_coconut_match_args, **_coconut_match_kwargs):  #86 (line in Coconut source)
...
class Grammar(_coconut.object):  #90 (line in Coconut source)
    ...
    commalist = _coconut.functools.partial(tokenlist, comma)  #100 (line in Coconut source)
    ...
    lowercase_name = Regex("[a-z0-9_]\w*'*")  #112 (line in Coconut source)
    uppercase_name = Regex("[A-Z]\w*'*")  #113 (line in Coconut source)
